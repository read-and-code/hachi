...
class Addition(leftExpression: ArithmeticExpression, rightExpression: ArithmeticExpression) : ArithmeticExpression(leftExpression, rightExpression, leftExpression.type) {
